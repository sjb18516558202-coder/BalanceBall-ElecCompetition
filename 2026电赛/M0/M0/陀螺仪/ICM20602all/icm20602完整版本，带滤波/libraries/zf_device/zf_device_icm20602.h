...
//====================================================硬件 SPI 驱动====================================================
// 默认沿用 E4_imu 例程中 IMU660RB 的 SPI1 接线，若 接线不同，只需要修改下面几个宏
...
// 默认配置：加速度 ±4g，陀螺仪 ±1000dps。
// 说明：小车做90度原地转向时，瞬时角速度可能接近或超过500dps；若量程饱和，会出现实际90度但Yaw偏小。
//      如果你的车转得很慢，并且更关心静止微小漂移，可改成 ICM20602_GYRO_SAMPLE_SGN_500DPS。
#define ICM20602_ACC_SAMPLE_DEFAULT                 ( ICM20602_ACC_SAMPLE_SGN_4G )
#define ICM20602_GYRO_SAMPLE_DEFAULT                ( ICM20602_GYRO_SAMPLE_SGN_500DPS )

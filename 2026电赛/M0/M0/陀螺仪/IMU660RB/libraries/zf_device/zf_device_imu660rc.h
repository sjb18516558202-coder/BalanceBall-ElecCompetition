...
//====================================================软件 IIC 驱动====================================================
#define IMU660RC_SOFT_IIC_DELAY         ( 10 )                                  // 软件 IIC 的时钟延时周期 数值越小 IIC 通信速率越快
#define IMU660RC_SCL_PIN                ( B23 )                                 // 软件 IIC SCL 引脚 连接 IMU660RC 的 SCL 引脚
#define IMU660RC_SDA_PIN                ( B22 )                                 // 软件 IIC SDA 引脚 连接 IMU660RC 的 SDA 引脚
//====================================================软件 IIC 驱动====================================================
#else

//====================================================硬件 SPI 驱动====================================================
#define IMU660RC_SPI_SPEED              ( 8 * 1000 * 1000)                      // 硬件 SPI 速率
#define IMU660RC_SPI                    ( SPI_1         )                       // 硬件 SPI 号
#define IMU660RC_SPC_PIN                ( SPI1_SCK_B23  )                       // 硬件 SPI SCK 引脚
#define IMU660RC_SDI_PIN                ( SPI1_MOSI_B22 )                       // 硬件 SPI MOSI 引脚
#define IMU660RC_SDO_PIN                ( SPI1_MISO_B21 )                       // 硬件 SPI MISO 引脚
//====================================================硬件 SPI 驱动====================================================
#endif

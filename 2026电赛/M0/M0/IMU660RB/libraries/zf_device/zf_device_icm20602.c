...
// 使用示例     icm20602_init();
// 备注信息     默认配置：加速度 ±4g，陀螺仪 ±250dps，关闭 I2C 接口，使用 SPI 通信
//-------------------------------------------------------------------------------------------------------------------
uint8 icm20602_init (void)
{
    ...
    do
    {
        ...
        icm20602_write_register(ICM20602_REG_SMPLRT_DIV, 0x00);                  // 采样率分频，默认 1kHz
        icm20602_write_register(ICM20602_REG_CONFIG,     0x03);                  // 陀螺仪低通滤波配置
        icm20602_write_register(ICM20602_REG_ACCEL_CONFIG2, 0x03);               // 加速度计低通滤波配置
